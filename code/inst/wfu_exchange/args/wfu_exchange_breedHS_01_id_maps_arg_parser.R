...
breedhs_parser <- argument_parser(
    ...
    argument_def('--all_wfu_ss', type = 'character', required = TRUE, nargs=3, # be sure to set the number of shipping sheets prior to running!
    ...
    argument_def('--all_hsw_ss', type = 'character', required = TRUE, nargs=1, # be sure to set the number of shipping sheets prior to running!
        help = 'bash array of file paths to WFU shipping sheets'),
    argument_def('--utils', type = 'character', required = TRUE,
        help = 'path to the HSW_utils.R script'),
