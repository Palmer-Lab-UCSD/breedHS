...
breedhs_parser <- argument_parser(
    ...
    argument_def('--ped_map', type = 'character', required = TRUE,
        help = 'path to the pedigree map (csv denoting how overlapping pedigree generations correspond)'),
    argument_def('--hsw_to_wfu', type = 'character', required = TRUE,
        help = 'path to the HSW --> WFU exchange history'),
    argument_def('--wfu_to_hsw', type = 'character', required = TRUE,
    ...
    argument_def('--colony_df', type = 'character', required = TRUE,
        help = 'the path to the current HSW colony dataframe'),
